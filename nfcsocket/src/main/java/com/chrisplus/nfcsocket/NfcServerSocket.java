...
public class NfcServerSocket {
	...
	/**
	 * MSG_SERVER_SELECT_MESSAGE is sent by {@link com.chrisplus.nfcsocket.HCEService} when a select
	 * message is received.
	 */
	public static final int MSG_SERVER_SELECT_MESSAGE = 1;

	/**
	 * MSG_SERVER_NORMAL_MESSAGE is sent by {@link com.chrisplus.nfcsocket.HCEService} when a normal
	 * message is received.
	 */
	public static final int MSG_SERVER_NORMAL_MESSAGE = 2;

	/**
	 * MSG_SERVER_DEACTIVE is send by {@link com.chrisplus.nfcsocket.HCEService} when deactivate. Two
