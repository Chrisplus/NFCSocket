...
/**
 * <p>
 * HostApduService is a convenience {@link Service} class that can be extended
 * to emulate an NFC card inside an Android service component.
 *
 * <div class="special reference">
 * <h3>Developer Guide</h3> * For a general introduction into the topic of card emulation, * please read the <a href="{@docRoot} * For a general introduction into the topic of card emulation, please read the * <a href="{@docRoot} * * For a general introduction into the topic of card emulation, * please read * the <a href="{@docRoot} For a general introduction into the topic of card * emulation, please read the <a href="{@docRoot} * * For a general introduction into the topic of card emulation, * please read * the <a href="{@docRoot} * For a general introduction into the topic of card * emulation, please read the * <a href="{@docRoot} * For a general introduction * into the topic of card emulation, * please read the <a href="{@docRoot} For a * general introduction into the topic of card emulation, please read the <a * href="{@docRoot} * * For a general introduction into the topic of card emulation, * please read * the <a href="{@docRoot} * For a general introduction into the topic of card * emulation, please read the * <a href="{@docRoot} * * For a general * introduction into the topic of card emulation, * please read * the <a * href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * For a general introduction * into the topic of card emulation, * please read the <a href="{@docRoot} * For * a general introduction into the topic of card emulation, please read the * <a * href="{@docRoot} * For a general introduction into the topic of card * emulation, * please read the <a href="{@docRoot} For a general introduction * into the topic of card emulation, please read the <a href="{@docRoot} * * For a general introduction into the topic of card emulation, * please read * the <a href="{@docRoot} * For a general introduction into the topic of card * emulation, please read the * <a href="{@docRoot} * * For a general * introduction into the topic of card emulation, * please read * the <a * href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * * For a general introduction * into the topic of card emulation, * please read * the <a href="{@docRoot} * * For a general introduction into the topic of card * emulation, please read * the * <a href="{@docRoot} * For a general introduction * into the topic of * card emulation, * please read the <a href="{@docRoot} For a * general * introduction into the topic of card emulation, please read the <a * * href="{@docRoot} * For a general introduction into the topic of card * emulation, * please read the <a href="{@docRoot} * For a general introduction * into the topic of card emulation, please read the * <a href="{@docRoot} * * * For a general introduction into the topic of card emulation, * please read * * the <a href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * For a general introduction * into the topic of card emulation, * please read the <a href="{@docRoot} * For * a general introduction into the topic of card emulation, please read the * <a * href="{@docRoot} * For a general introduction into the topic of card * emulation, * please read the <a href="{@docRoot} For a general introduction * into the topic of card emulation, please read the <a href="{@docRoot} * * For a general introduction into the topic of card emulation, * please read * the <a href="{@docRoot} * For a general introduction into the topic of card * emulation, please read the * <a href="{@docRoot} * * For a general * introduction into the topic of card emulation, * please read * the <a * href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * * For a general introduction * into the topic of card emulation, * please read * the <a href="{@docRoot} * * For a general introduction into the topic of card * emulation, please read * the * <a href="{@docRoot} * For a general introduction * into the topic of * card emulation, * please read the <a href="{@docRoot} For a * general * introduction into the topic of card emulation, please read the <a * * href="{@docRoot} * * For a general introduction into the topic of card * emulation, * please read * the <a href="{@docRoot} * For a general * introduction into the topic of card * emulation, please read the * <a * href="{@docRoot} * * For a general * introduction into the topic of card * emulation, * please read * the <a * href="{@docRoot} For a general * introduction into the topic of card * * emulation, please read the <a * href="{@docRoot} * For a general introduction * into the topic of card * emulation, * please read the <a href="{@docRoot} * For * a general * introduction into the topic of card emulation, please read the * <a * * href="{@docRoot} * For a general introduction into the topic of card * * emulation, * please read the <a href="{@docRoot} For a general introduction * * into the topic of card emulation, please read the <a href="{@docRoot} * For a * general introduction into the topic of card emulation, * please read the <a * href="{@docRoot} * For a general introduction into the topic of card * emulation, please read the * <a href="{@docRoot} * * For a general * introduction into the topic of card emulation, * please read * the <a * href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * * For a general introduction * into the topic of card emulation, * please read * the <a href="{@docRoot} * * For a general introduction into the topic of card * emulation, please read * the * <a href="{@docRoot} * For a general introduction * into the topic of * card emulation, * please read the <a href="{@docRoot} For a * general * introduction into the topic of card emulation, please read the <a * * href="{@docRoot} * For a general introduction into the topic of card * emulation, * please read the <a href="{@docRoot} * For a general introduction * into the topic of card emulation, please read the * <a href="{@docRoot} * * * For a general introduction into the topic of card emulation, * please read * * the <a href="{@docRoot} For a general introduction into the topic of card * * emulation, please read the <a href="{@docRoot} * For a general introduction * into the topic of card emulation, * please read the <a href="{@docRoot} * For * a general introduction into the topic of card emulation, please read the * <a * href="{@docRoot} * For a general introduction into the topic of card * emulation, * please read the <a href="{@docRoot} For a general introduction * into the topic of card emulation, please read the <a href="{@docRoot}
 * * For a general introduction into the topic of card emulation, * please read
 * the <a href="{@docRoot} * For a general introduction into the topic of card
 * emulation, please read the * <a href="{@docRoot} * * For a general
 * introduction into the topic of card emulation, * please read * the <a
 * href="{@docRoot} For a general introduction into the topic of card *
 * emulation, please read the <a href="{@docRoot} * * For a general introduction
 * into the topic of card emulation, * please read * the <a href="{@docRoot} *
 * For a general introduction into the topic of card * emulation, please read
 * the * <a href="{@docRoot} * For a general introduction * into the topic of
 * card emulation, * please read the <a href="{@docRoot} For a * general
 * introduction into the topic of card emulation, please read the <a *
 * href="{@docRoot} * * For a general introduction into the topic of card
 * emulation, * please read * the <a href="{@docRoot} * For a general
 * introduction into the topic of card * emulation, please read the * <a
 ...
 * href="{@docRoot} * For a general introduction into the topic of card *
 * emulation, * please read the <a href="{@docRoot} For a general introduction *
 * into the topic of card emulation, please read the <a href="{@docRoot} * * For
 * a general introduction into the topic of card emulation, * please read * the
 * <a href="{@docRoot} * For a general introduction into the topic of card *
 * emulation, please read the * <a href="{@docRoot} * * For a general *
 * introduction into the topic of card emulation, * please read * the <a *
 * href="{@docRoot} For a general introduction into the topic of card * *
 * emulation, please read the <a href="{@docRoot} * * For a general introduction
 ...
 * emulation, please read the <a href="{@docRoot} * For a general introduction
 * into the topic of card emulation, * please read the <a href="{@docRoot} * For
 * a general introduction into the topic of card emulation, please read the * <a
 * href="{@docRoot} * * For a general introduction into the topic of card
 * emulation, * please read * the <a href="{@docRoot} For a general introduction
 * into the topic of card * emulation, please read the <a href="{@docRoot} * *
 * For a general introduction into the topic of card emulation, * please read *
 ...
 * href="{@docRoot} * For a general introduction into the topic of card *
 * emulation, * please read the <a href="{@docRoot} For a general introduction *
 * into the topic of card emulation, please read the <a href="{@docRoot} * For a
 * general introduction into the topic of card emulation, * please read the <a
 * href="{@docRoot} * For a general introduction into the topic of card
 * emulation, please read the * <a href="{@docRoot} * * For a general
 * introduction into the topic of card emulation, * please read * the <a
 * href="{@docRoot} For a general introduction into the topic of card *
 ...
 * emulation, * please read the <a href="{@docRoot} For a general introduction
 * into the topic of card emulation, please read the <a href="{@docRoot}
 * guide/topics/nfc/ce.html"> NFC card emulation developer guide.</a>
 * </p>
 * </div>
 *
 * <h3>NFC Protocols</h3>
 * <p>
 * Cards emulated by this class are based on the NFC-Forum ISO-DEP protocol
 * (based on ISO/IEC 14443-4) and support processing command Application
 * Protocol Data Units (APDUs) as defined in the ISO/IEC 7816-4 specification.
 *
 * <h3>Service selection</h3>
 * <p>
 * When a remote NFC device wants to talk to your service, it sends a so-called
 * "SELECT AID" APDU as defined in the ISO/IEC 7816-4 specification. The AID is
 * an application identifier defined in ISO/IEC 7816-4.
 *
 * <p>
 ...
 * risk of collisions with other applications that might be using proprietary
 * AIDs as well.
 *
 * <h3>AID groups</h3>
 * <p>
 * In some cases, a service may need to register multiple AIDs to implement a
 * certain application, and it needs to be sure that it is the default handler
 * for all of these AIDs (as opposed to some AIDs in the group going to another
 * service).
 *
 * <p>
 * An AID group is a list of AIDs that should be considered as belonging
 * together by the OS. For all AIDs in an AID group, the OS will guarantee one
 * of the following:
 * <ul>
 * <li>All AIDs in the group are routed to this service
 * <li>No AIDs in the group are routed to this service
 * </ul>
 * In other words, there is no in-between state, where some AIDs in the group
 * can be routed to this service, and some to another.
 * <h3>AID groups and categories</h3>
 * <p>
 * Each AID group can be associated with a category. This allows the Android OS
 * to classify services, and it allows the user to set defaults at the category
 * level instead of the AID level.
 *
 * <p>
 * You can use
 ...
 * {@link CardEmulation#CATEGORY_PAYMENT} and
 * {@link CardEmulation#CATEGORY_OTHER}. AID groups without a category, or with
 * a category that is not recognized by the current platform version, will
 * automatically be grouped into the {@link CardEmulation#CATEGORY_OTHER}
 * category.
 * <h3>Service AID registration</h3>
 * <p>
 * To tell the platform which AIDs groups are requested by this service, a
 * {@link #SERVICE_META_DATA} entry must be included in the declaration of the
 * service. An example of a HostApduService manifest declaration is shown below:
 * 
 * <pre>
 ...
 *
 * <p>
 * The {@link android.R.styleable#HostApduService &lt;host-apdu-service&gt;} is
 * required to contain a {@link android.R.styleable#HostApduService_description
 * &lt;android:description&gt;} attribute that contains a user-friendly
 * description of the service that may be shown in UI. The
 * {@link android.R.styleable#HostApduService_requireDeviceUnlock
 * &lt;requireDeviceUnlock&gt;} attribute can be used to specify that the device
 * must be unlocked before this service can be invoked to handle APDUs.
 * <p>
 * The {@link android.R.styleable#HostApduService &lt;host-apdu-service&gt;}
 * must contain one or more {@link android.R.styleable#AidGroup
 * &lt;aid-group&gt;} tags. Each {@link android.R.styleable#AidGroup
 * &lt;aid-group&gt;} must contain one or more
 * {@link android.R.styleable#AidFilter &lt;aid-filter&gt;} tags, each of which
 * contains a single AID. The AID must be specified in hexadecimal format, and
 * contain an even number of characters.
 * <h3>AID conflict resolution</h3>
 * Multiple HostApduServices may be installed on a single device, and the same
 * AID can be registered by more than one service. The Android platform resolves
 * AID conflicts depending on which category an AID belongs to. Each category
 * may have a different conflict resolution policy. For example, for some
 * categories the user may be able to select a default service in the Android
 * settings UI. For other categories, to policy may be to always ask the user
 * which service is to be invoked in case of conflict.
 *
 ...
 * service component, the "SELECT AID" command APDU and all subsequent command
 * APDUs will be sent to that service through
 ...
 * {@link PackageManager#FEATURE_NFC_HOST_CARD_EMULATION} to be present on the
 * device.
 *
 */
public abstract class MyHostApduService extends Service {
	/**
